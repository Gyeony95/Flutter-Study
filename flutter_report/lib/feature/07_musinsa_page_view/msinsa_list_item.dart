...
class MusinsaListItem extends StatefulWidget {
  final int index;
  ...
  @override
  State<StatefulWidget> createState() => _MusinsaListItem();
}

class _MusinsaListItem extends State<MusinsaListItem> {
