                  ...
                  if (Platform.isAndroid
                    ...
                    if (images?.isNotEmpty == true) {
                      ...
                      images.forEach(
                          ...
                          _mainBloc..add(GetImageData(image, file, mData));
                          ...
                          var request_json = {
                            ...
                            // try{
                              ...
                              if (response.statusCode == HttpStatus.ok) {
                                ...
                                // var base = data.images[0].idCard['result']['dl'];
                                // var type = base['type'][0]['text'];
                                // var type_vertices = base['type'][0]['vertices'];
                                // // log('ghghgh data '+type+'   '+type_vertices);
                                ...
                                log('ghghgh '+name);
                                log('ghghgh '+num);
                                log('ghghgh '+personalNum);

                                log('ghghgh data '+data.images[0].idCard['result']['dl']['type'][0]['text'].toString()??'');
